...
<c:set var="book" value="${param.book1}"/>

<c:set var="bookId1" value="${book.bookId}"/>
<c:set var="bookTitle1" value="${book.bookTitle}"/>
<c:set var="authorFirst1" value="${book.author.firstName}"/>
<c:set var="authorLast1" value="${book.author.firstName}"/>
<c:set var="chaptersNum1" value="${book.halfBookChptr}"/>
<c:set var="book1Chpt" value="${book.book1CurrChapter }"/>
		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<td align="right">
						<a href="${pageContext.request.contextPath}/vitepub/publishercontroller/bookchapterspage?bookId=${bookId}&chapterNum=${currentChapter}&chapterCount=${readablechpts1}&typebook=${fullorhalf}&frombookshelf=true">
							<div
